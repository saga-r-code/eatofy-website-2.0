  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <div className="home w-[100vw] h-[100vh] text-[#ead1b3] overflow-hidden relative">
        <Image src="./bg-1.jpg" alt="bg" class="bg-img" />
        ...
        <div className="flex justify-center items-center flex-col  my-3 sm:mt-10  xl:hidden " >
          <div className="w-[1px] h-20 bg-[#42464d]"></div>
          <div className="w-5 h-5 border-2 rounded-full border-[#42464d]"></div>
        </div>
          ...
          <div className="projects w-[100vw] md:w-[60vw] xl:w-[40vw] rounded-md">
            ...
            >
              <div>
                ...
                <Image src="./feature-1.jpg" alt="feature" />
              </div>
              <div>
                <h1 className="mb-3 font-semibold text-xl text-[#ead1b3] underline underline-offset-4">
                  Point OF Sale (POS)
                </h1>
                <Image src="./feature-2.jpg" alt="feature" />
              </div>
              <div>
                <h1 className="mb-3 font-semibold text-xl text-[#ead1b3] underline underline-offset-4">
                  Report And Analysis
                </h1>
                <Image src="./feature-3.jpeg" alt="feature" />
              </div>
            </Carousel>
          </div>
          {/* Projects-end */}
      ...
      <div
        id="contact"
        className="info text-[#ead1b3] w-[100vw] relative p-10 overflow-hidden"
      >
        <div className="blur-effect">
        ...
        <section className="bg-[#0f1a28] text-[#ead1b3] px-3 lg:w-[80%] mx-auto h-auto py-20  my-32 flex justify-center items-center gap-10 flex-col rounded-xl">
          <h2 className="text-xl  underline underline-offset-4 text-center lg:text-2xl">Contact Us</h2>
